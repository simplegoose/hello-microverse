...
> This is my first microverse project. This was completed during week 1.
...
```sh
  cd my-folder
  git clone git@github.com:simplegoose/hello-microverse.git
```
--->
...
- Twitter: [@njorogemwangi21](https://twitter.com/njorogemwangi21)
